...
public class JMClient_cis_cust_prod_hold extends AbstractJavaSamplerClient {
	...
	public void setupTest(JavaSamplerContext jsc) {
		...
		this.region = jsc.getParameter("region", "cis_cust_prod_hold");
	...
	public Arguments getDefaultParameters() {
		...
		params.addArgument("region", "cis_cust_prod_hold");
	...
	public static void main(String[] args) {
		...
		JMClient_cis_cust_prod_hold test = new JMClient_cis_cust_prod_hold();
		test.setupTest(arg0);
		test.runTest(arg0);
