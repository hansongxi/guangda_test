...
public class JMClient_cis_cust_info extends AbstractJavaSamplerClient {
	...
	public void setupTest(JavaSamplerContext jsc) {
		...
		this.region = jsc.getParameter("region", "cis_cust_info");
	...
	public Arguments getDefaultParameters() {
		...
		params.addArgument("region", "cis_cust_info");
	...
	public static void main(String[] args) {
		...
		JMClient_cis_cust_info test = new JMClient_cis_cust_info();
		test.setupTest(arg0);
		test.runTest(arg0);
