...
public class CisCustInfo 
	implements Comparable<CisCustInfo>,PdxSerializable{
	/**
	 * 
	 */
	...
	public void toData(PdxWriter writer) {
		...
		writer.writeString("open_subbank_id",open_subbank_id);
		writer.writeInt("open_mon",open_mon);
		writer.writeString("cust_act_ind",cust_act_ind);
		writer.writeDouble("profit",profit);
		writer.writeDouble("dept_profit",dept_profit);
		writer.writeDouble("loan_profit",loan_profit);
		writer.writeDouble("ibiz_profit",ibiz_profit);
		writer.writeDouble("cd_profit",cd_profit);
		writer.writeDouble("profit_rate",profit_rate);
		writer.writeInt("dept_acct_qty",dept_acct_qty);
		writer.writeDouble("dept_bal_amt",dept_bal_amt);
		writer.writeDouble("dept_month_avg_bal",dept_month_avg_bal);
		writer.writeDouble("dept_quarter_avg_bal",dept_quarter_avg_bal);
		writer.writeDouble("dept_year_avg_bal",dept_year_avg_bal);
		writer.writeInt("fixed_dept_acct_qty",fixed_dept_acct_qty);
		writer.writeDouble("fixed_dept_bal_amt",fixed_dept_bal_amt);
		writer.writeDouble("fixed_dept_month_avg_bal",fixed_dept_month_avg_bal);
		writer.writeDouble("fixed_dept_quarter_avg_bal",fixed_dept_quarter_avg_bal);
		writer.writeDouble("fixed_dept_year_avg_bal",fixed_dept_year_avg_bal);
		writer.writeInt("saving_dept_acct_qty",saving_dept_acct_qty);
		writer.writeDouble("saving_dept_bal_amt",saving_dept_bal_amt);
		writer.writeDouble("saving_dept_month_avg_bal",saving_dept_month_avg_bal);
		writer.writeDouble("saving_dept_quarter_avg_bal",saving_dept_quarter_avg_bal);
		writer.writeDouble("saving_dept_year_avg_bal",saving_dept_year_avg_bal);
		writer.writeInt("l_dept_acct_qty",l_dept_acct_qty);
		writer.writeDouble("l_dept_bal_amt",l_dept_bal_amt);
		writer.writeDouble("l_dept_month_avg_bal",l_dept_month_avg_bal);
		writer.writeDouble("l_dept_quarter_avg_bal",l_dept_quarter_avg_bal);
		writer.writeDouble("l_dept_year_avg_bal",l_dept_year_avg_bal);
		writer.writeInt("f_dept_acct_qty",f_dept_acct_qty);
		writer.writeDouble("f_dept_bal_amt",f_dept_bal_amt);
		writer.writeDouble("f_dept_month_avg_bal",f_dept_month_avg_bal);
		writer.writeDouble("f_dept_quarter_avg_bal",f_dept_quarter_avg_bal);
		writer.writeDouble("f_dept_year_avg_bal",f_dept_year_avg_bal);
		writer.writeInt("fin_type_qty",fin_type_qty);
		writer.writeInt("fin_acct_qty",fin_acct_qty);
		writer.writeDouble("fin_bal_amt",fin_bal_amt);
		writer.writeDouble("fin_month_avg_bal",fin_month_avg_bal);
		writer.writeDouble("fin_quarter_avg_bal",fin_quarter_avg_bal);
		writer.writeDouble("fin_year_avg_bal",fin_year_avg_bal);
		writer.writeInt("l_fin_type_qty",l_fin_type_qty);
		writer.writeInt("l_fin_acct_qty",l_fin_acct_qty);
		writer.writeDouble("l_fin_bal_amt",l_fin_bal_amt);
		writer.writeDouble("l_fin_month_avg_bal",l_fin_month_avg_bal);
		writer.writeDouble("l_fin_quarter_avg_bal",l_fin_quarter_avg_bal);
		writer.writeDouble("l_fin_year_avg_bal",l_fin_year_avg_bal);
		writer.writeInt("f_fin_type_qty",f_fin_type_qty);
		writer.writeInt("f_fin_acct_qty",f_fin_acct_qty);
		writer.writeDouble("f_fin_bal_amt",f_fin_bal_amt);
		writer.writeDouble("f_fin_month_avg_bal",f_fin_month_avg_bal);
		writer.writeDouble("f_fin_quarter_avg_bal",f_fin_quarter_avg_bal);
		writer.writeDouble("f_fin_year_avg_bal",f_fin_year_avg_bal);
		writer.writeInt("fin_dept_acct_qty",fin_dept_acct_qty);
		writer.writeDouble("fin_dept_bal_amt",fin_dept_bal_amt);
		writer.writeDouble("fin_dept_month_avg_bal",fin_dept_month_avg_bal);
		writer.writeDouble("fin_dept_quarter_avg_bal",fin_dept_quarter_avg_bal);
		writer.writeDouble("fin_dept_year_avg_bal",fin_dept_year_avg_bal);
		writer.writeInt("l_fin_dept_acct_qty",l_fin_dept_acct_qty);
		writer.writeDouble("l_fin_dept_bal_amt",l_fin_dept_bal_amt);
		writer.writeDouble("l_fin_dept_month_avg_bal",l_fin_dept_month_avg_bal);
		writer.writeDouble("l_fin_dept_quarter_avg_bal",l_fin_dept_quarter_avg_bal);
		writer.writeDouble("l_fin_dept_year_avg_bal",l_fin_dept_year_avg_bal);
		writer.writeInt("f_fin_dept_acct_qty",f_fin_dept_acct_qty);
		writer.writeDouble("f_fin_dept_bal_amt",f_fin_dept_bal_amt);
		writer.writeDouble("f_fin_dept_month_avg_bal",f_fin_dept_month_avg_bal);
		writer.writeDouble("f_fin_dept_quarter_avg_bal",f_fin_dept_quarter_avg_bal);
		writer.writeDouble("f_fin_dept_year_avg_bal",f_fin_dept_year_avg_bal);
		writer.writeInt("l_fin_fund_acct_qty",l_fin_fund_acct_qty);
		writer.writeDouble("l_fin_fund_bal_amt",l_fin_fund_bal_amt);
		writer.writeDouble("l_fin_fund_month_avg_bal",l_fin_fund_month_avg_bal);
		writer.writeDouble("l_fin_fund_quarter_avg_bal",l_fin_fund_quarter_avg_bal);
		writer.writeDouble("l_fin_fund_year_avg_bal",l_fin_fund_year_avg_bal);
		writer.writeInt("f_fin_fund_acct_qty",f_fin_fund_acct_qty);
		writer.writeDouble("f_fin_fund_bal_amt",f_fin_fund_bal_amt);
		writer.writeDouble("f_fin_fund_month_avg_bal",f_fin_fund_month_avg_bal);
		writer.writeDouble("f_fin_fund_quarter_avg_bal",f_fin_fund_quarter_avg_bal);
		writer.writeDouble("f_fin_fund_year_avg_bal",f_fin_fund_year_avg_bal);
		writer.writeInt("debt_acct_qty",debt_acct_qty);
		writer.writeDouble("debt_bal_amt",debt_bal_amt);
		writer.writeDouble("debt_month_avg_bal",debt_month_avg_bal);
		writer.writeDouble("debt_quarter_avg_bal",debt_quarter_avg_bal);
		writer.writeDouble("debt_year_avg_bal",debt_year_avg_bal);
		writer.writeInt("fund_acct_qty",fund_acct_qty);
		writer.writeDouble("fund_bal_amt",fund_bal_amt);
		writer.writeDouble("fund_month_avg_bal",fund_month_avg_bal);
		writer.writeDouble("fund_quarter_avg_bal",fund_quarter_avg_bal);
		writer.writeDouble("fund_year_avg_bal",fund_year_avg_bal);
		writer.writeInt("gold_acct_qty",gold_acct_qty);
		writer.writeDouble("gold_bal",gold_bal);
		writer.writeDouble("mon_avg_gold_bal",mon_avg_gold_bal);
		writer.writeDouble("qtr_avg_gold_bal",qtr_avg_gold_bal);
		writer.writeDouble("year_avg_gold_bal",year_avg_gold_bal);
		writer.writeInt("ins_acct_qty",ins_acct_qty);
		writer.writeDouble("ins_bal",ins_bal);
		writer.writeDouble("mon_avg_ins_bal",mon_avg_ins_bal);
		writer.writeDouble("qtr_avg_ins_bal",qtr_avg_ins_bal);
		writer.writeDouble("year_avg_ins_bal",year_avg_ins_bal);
		writer.writeInt("sjob_acct_qty",sjob_acct_qty);
		writer.writeDouble("sjob_bal",sjob_bal);
		writer.writeDouble("mon_avg_sjob_bal",mon_avg_sjob_bal);
		writer.writeDouble("qtr_avg_sjob_bal",qtr_avg_sjob_bal);
		writer.writeDouble("year_avg_sjob_bal",year_avg_sjob_bal);
		writer.writeInt("accd_acct_qty",accd_acct_qty);
		writer.writeDouble("accd_bal",accd_bal);
		writer.writeDouble("mon_avg_accd_bal",mon_avg_accd_bal);
		writer.writeDouble("qtr_avg_accd_bal",qtr_avg_accd_bal);
		writer.writeDouble("year_avg_accd_bal",year_avg_accd_bal);
		writer.writeInt("ta_fin_acct_qty",ta_fin_acct_qty);
		writer.writeDouble("ta_fin_bal_amt",ta_fin_bal_amt);
		writer.writeDouble("ta_fin_month_avg_bal",ta_fin_month_avg_bal);
		writer.writeDouble("ta_fin_quarter_avg_bal",ta_fin_quarter_avg_bal);
		writer.writeDouble("ta_fin_year_avg_bal",ta_fin_year_avg_bal);
		writer.writeInt("dept_trs_acct_qty",dept_trs_acct_qty);
		writer.writeDouble("dept_trs_bal_amt",dept_trs_bal_amt);
		writer.writeDouble("dept_trs_month_avg_bal",dept_trs_month_avg_bal);
		writer.writeDouble("dept_trs_quarter_avg_bal",dept_trs_quarter_avg_bal);
		writer.writeDouble("dept_trs_year_avg_bal",dept_trs_year_avg_bal);
		writer.writeInt("l_dept_trs_acct_qty",l_dept_trs_acct_qty);
		writer.writeDouble("l_dept_trs_bal_amt",l_dept_trs_bal_amt);
		writer.writeDouble("l_dept_trs_month_avg_bal",l_dept_trs_month_avg_bal);
		writer.writeDouble("l_dept_trs_quarter_avg_bal",l_dept_trs_quarter_avg_bal);
		writer.writeDouble("l_dept_trs_year_avg_bal",l_dept_trs_year_avg_bal);
		writer.writeInt("loan_acct_qty",loan_acct_qty);
		writer.writeDouble("loan_issue_amt",loan_issue_amt);
		writer.writeDouble("loan_bal_amt",loan_bal_amt);
		writer.writeDouble("nloan_amt",nloan_amt);
		writer.writeDouble("loan_month_avg_bal",loan_month_avg_bal);
		writer.writeDouble("loan_quarter_avg_bal",loan_quarter_avg_bal);
		writer.writeDouble("loan_year_avg_bal",loan_year_avg_bal);
		writer.writeInt("micro_acct_qty",micro_acct_qty);
		writer.writeDouble("micro_issue_amt",micro_issue_amt);
		writer.writeDouble("micro_bal_amt",micro_bal_amt);
		writer.writeDouble("micro_month_avg_bal",micro_month_avg_bal);
		writer.writeDouble("micro_quarter_avg_bal",micro_quarter_avg_bal);
		writer.writeDouble("micro_year_avg_bal",micro_year_avg_bal);
		writer.writeInt("sc_acct_qty",sc_acct_qty);
		writer.writeDouble("sc_bal_amt",sc_bal_amt);
		writer.writeDouble("sc_bal_month_avg_bal",sc_bal_month_avg_bal);
		writer.writeDouble("sc_bal_quarter_avg_bal",sc_bal_quarter_avg_bal);
		writer.writeDouble("sc_bal_year_avg_bal",sc_bal_year_avg_bal);
		writer.writeInt("ccard_acct_qty",ccard_acct_qty);
		writer.writeInt("ccard_card_qty",ccard_card_qty);
		writer.writeDouble("ccard_limit_amt",ccard_limit_amt);
		writer.writeDouble("ccard_usable_amt",ccard_usable_amt);
		writer.writeDouble("ccard_month_amt",ccard_month_amt);
		writer.writeDouble("ccard_year_amt",ccard_year_amt);
		writer.writeDouble("ccard_year_avg_amt",ccard_year_avg_amt);
		writer.writeDouble("ccard_total_purchases_amt",ccard_total_purchases_amt);
		writer.writeDouble("ast2_bal_amt",ast2_bal_amt);
		writer.writeDouble("ast2_month_avg_bal",ast2_month_avg_bal);
		writer.writeDouble("ast2_quarter_avg_bal",ast2_quarter_avg_bal);
		writer.writeDouble("ast2_year_avg_bal",ast2_year_avg_bal);
		writer.writeDouble("ast4_bal_amt",ast4_bal_amt);
		writer.writeDouble("ast4_month_avg_bal",ast4_month_avg_bal);
		writer.writeDouble("ast4_quarter_avg_bal",ast4_quarter_avg_bal);
		writer.writeDouble("ast4_year_avg_bal",ast4_year_avg_bal);
		writer.writeDouble("assert9_bal",assert9_bal);
		writer.writeDouble("mon_avg_assert9_bal",mon_avg_assert9_bal);
		writer.writeDouble("qtr_avg_assert9_bal",qtr_avg_assert9_bal);
		writer.writeDouble("year_avg_assert9_bal",year_avg_assert9_bal);
		writer.writeInt("hold_dept_ind",hold_dept_ind);
		writer.writeInt("hold_fin_ind",hold_fin_ind);
		writer.writeInt("hold_debt_ind",hold_debt_ind);
		writer.writeInt("hold_fund_ind",hold_fund_ind);
		writer.writeInt("hold_loan_ind",hold_loan_ind);
		writer.writeInt("hold_sc_ind",hold_sc_ind);
		writer.writeInt("hold_ccard_ind",hold_ccard_ind);
		writer.writeInt("hold_gold_ind",hold_gold_ind);
		writer.writeInt("hold_ins_ind",hold_ins_ind);
		writer.writeInt("hold_sjob_ind",hold_sjob_ind);
		writer.writeInt("hold_accd_ind",hold_accd_ind);
		writer.writeInt("hold_prod_type_num",hold_prod_type_num);
		writer.writeInt("hold_prod_num",hold_prod_num);
		writer.writeInt("sc_sign_ind",sc_sign_ind);
		writer.writeString("sc_sign_dt",sc_sign_dt);
		writer.writeInt("nb_sign_ind",nb_sign_ind);
		writer.writeString("nb_sign_dt",nb_sign_dt);
		writer.writeInt("mb_sign_ind",mb_sign_ind);
		writer.writeString("mb_sign_dt",mb_sign_dt);
		writer.writeInt("sms_sign_ind",sms_sign_ind);
		writer.writeString("sms_sign_dt",sms_sign_dt);
		writer.writeInt("saly_sign_ind",saly_sign_ind);
		...
		writer.writeInt("prod_num",prod_num);
		writer.writeString("prod_sav",prod_sav);
		writer.writeString("prod_fin",prod_fin);
		writer.writeString("prod_fin_nav",prod_fin_nav);
		writer.writeString("prod_fin_fixed_income",prod_fin_fixed_income);
		writer.writeString("prod_fin_indiv",prod_fin_indiv);
		writer.writeString("prod_fun",prod_fun);
		writer.writeString("prod_bon",prod_bon);
		writer.writeString("prod_sec",prod_sec);
		writer.writeString("prod_gld",prod_gld);
		writer.writeString("prod_tru",prod_tru);
		writer.writeString("prod_pot",prod_pot);
		writer.writeString("prod_idr",prod_idr);
		writer.writeString("prod_lod",prod_lod);
		writer.writeString("prod_lod_house",prod_lod_house);
		writer.writeString("prod_lod_compre_cre",prod_lod_compre_cre);
		writer.writeString("prod_lod_compre_oth",prod_lod_compre_oth);
		writer.writeString("prod_lod_ple",prod_lod_ple);
		writer.writeString("prod_lod_entru",prod_lod_entru);
		writer.writeString("prod_crd",prod_crd);
		writer.writeString("prod_mic",prod_mic);
		writer.writeString("prod_mic_coml_mortg",prod_mic_coml_mortg);
		writer.writeString("prod_mic_housing",prod_mic_housing);
		writer.writeString("prod_mic_oth_aid",prod_mic_oth_aid);
		writer.writeString("prod_mic_chan",prod_mic_chan);
		writer.writeString("prod_mic_cons",prod_mic_cons);
		writer.writeString("prod_pay",prod_pay);
		writer.writeString("prod_btch_cr",prod_btch_cr);
		writer.writeString("prod_btch_dr",prod_btch_dr);
		writer.writeString("prod_fxa",prod_fxa);
		writer.writeString("prod_fxa_settle",prod_fxa_settle);
		writer.writeString("prod_fxa_dept",prod_fxa_dept);
		writer.writeString("prod_fbp",prod_fbp);
		writer.writeString("prod_elc",prod_elc);
		writer.writeString("prod_ela",prod_ela);
		writer.writeString("prod_clt",prod_clt);
		writer.writeString("prod_p2p",prod_p2p);
		writer.writeString("prod_mcm",prod_mcm);
		writer.writeString("hold_res1",hold_res1);
		writer.writeString("hold_res2",hold_res2);
		writer.writeString("hold_res3",hold_res3);
		writer.writeString("group_deposit",group_deposit);
		writer.writeString("group_fincing",group_fincing);
		writer.writeString("group_na_fincing",group_na_fincing);
		writer.writeString("group_fincing_agent",group_fincing_agent);
		writer.writeString("group_fincing_agent_fud",group_fincing_agent_fud);
		writer.writeString("group_fincing_agent_ins",group_fincing_agent_ins);
		writer.writeString("group_fincing_agent_tru",group_fincing_agent_tru);
		writer.writeString("group_fincing_agent_bon",group_fincing_agent_bon);
		writer.writeString("group_fincing_sc",group_fincing_sc);
		writer.writeString("group_microbiz",group_microbiz);
		writer.writeString("group_mic_loan",group_mic_loan);
		writer.writeString("group_mic_loan_com",group_mic_loan_com);
		writer.writeString("group_mic_loan_hous",group_mic_loan_hous);
		writer.writeString("group_mic_loan_oth",group_mic_loan_oth);
		writer.writeString("group_mic_loan_chan",group_mic_loan_chan);
		writer.writeString("group_mic_loan_cons",group_mic_loan_cons);
		writer.writeString("group_mic_rela",group_mic_rela);
		writer.writeString("group_loan",group_loan);
		writer.writeString("group_loan_house",group_loan_house);
		writer.writeString("group_loan_compre",group_loan_compre);
		writer.writeString("group_loan_compre_cre",group_loan_compre_cre);
		writer.writeString("group_loan_compre_oth",group_loan_compre_oth);
		writer.writeString("group_loan_ple",group_loan_ple);
		writer.writeString("group_loan_ent",group_loan_ent);
		writer.writeString("group_creditcard",group_creditcard);
		writer.writeString("group_batch_cr",group_batch_cr);
		writer.writeString("group_batch_salary",group_batch_salary);
		writer.writeString("group_batch_inter",group_batch_inter);
		writer.writeString("group_batch_spec",group_batch_spec);
		writer.writeString("group_batch_oth",group_batch_oth);
		writer.writeString("group_finaboard",group_finaboard);
		writer.writeString("group_finaboard_settle",group_finaboard_settle);
		writer.writeString("group_finaboard_dept",group_finaboard_dept);
		writer.writeString("group_finaboard_sun",group_finaboard_sun);
		writer.writeString("group_pwm",group_pwm);
		writer.writeString("group_res1",group_res1);
		writer.writeString("group_res2",group_res2);
		writer.writeString("group_res3",group_res3);
		writer.writeDouble("cust_flag",cust_flag);
		writer.writeString("asset_debit_lvl_id",asset_debit_lvl_id);
		writer.writeString("asset_debit_lvl_cid",asset_debit_lvl_cid);
		writer.writeString("fin_asset_debit_lvl_id",fin_asset_debit_lvl_id);
		writer.writeString("fin_asset_debit_lvl_cid",fin_asset_debit_lvl_cid);
		writer.writeString("fin_mon1",fin_mon1);
		writer.writeString("fin_mon2",fin_mon2);
		writer.writeString("fin_mon3",fin_mon3);
		writer.writeString("ccd_asset_debit_lvl_id",ccd_asset_debit_lvl_id);
		writer.writeString("ln_asset_debit_lvl_id",ln_asset_debit_lvl_id);
		writer.writeString("ln_asset_debit_lvl_cid",ln_asset_debit_lvl_cid);
		writer.writeString("ln_mon1",ln_mon1);
		writer.writeString("ln_mon2",ln_mon2);
		writer.writeString("ln_mon3",ln_mon3);
		writer.writeString("ln_mon4",ln_mon4);
		writer.writeString("ln_mon5",ln_mon5);
		writer.writeString("ln_mon6",ln_mon6);
		writer.writeInt("asset_debit_lvl_times",asset_debit_lvl_times);
		writer.writeInt("fin_asset_debit_lvl_times",fin_asset_debit_lvl_times);
		writer.writeInt("ln_asset_debit_lvl_times",ln_asset_debit_lvl_times);
		writer.writeInt("ccd_asset_debit_lvl_times",ccd_asset_debit_lvl_times);
		writer.writeString("cust_flg",cust_flg);
		writer.writeInt("cust_lost_flg",cust_lost_flg);
		writer.writeString("assets_debt_lvl_cd",assets_debt_lvl_cd);
		writer.writeString("fin_assets_debt_lvl_cd",fin_assets_debt_lvl_cd);
		writer.writeString("ln_assets_debt_lvl_cd",ln_assets_debt_lvl_cd);
		writer.writeString("ccd_assets_debt_lvl_cd",ccd_assets_debt_lvl_cd);
		writer.writeString("assets_lvl_cd",assets_lvl_cd);
		writer.writeString("profit_lvl_cd",profit_lvl_cd);
		writer.writeDouble("day_profit",day_profit);
		writer.writeDouble("profit_mon_base",profit_mon_base);
		writer.writeString("rgstr_sign_use_lvl_id",rgstr_sign_use_lvl_id);
		writer.writeString("retl_rgstr_sign_use_lvl_id",retl_rgstr_sign_use_lvl_id);
		writer.writeString("ccd_rgstr_sign_use_lvl_id",ccd_rgstr_sign_use_lvl_id);
		writer.writeString("echl_rgstr_sign_use_lvl_id",echl_rgstr_sign_use_lvl_id);
		writer.writeString("buy_freq_lvl_id",buy_freq_lvl_id);
		writer.writeString("activ_lvl_id",activ_lvl_id);
		writer.writeString("retl_activ_lvl_id",retl_activ_lvl_id);
		writer.writeString("ccd_activ_lvl_id",ccd_activ_lvl_id);
		writer.writeString("echl_activ_lvl_id",echl_activ_lvl_id);
		writer.writeString("cust_lylty",cust_lylty);
		writer.writeString("lylty_lvl_id",lylty_lvl_id);
		writer.writeString("fin_manager",fin_manager);
		writer.writeString("ln_manager",ln_manager);
		writer.writeString("ccd_manager",ccd_manager);
		writer.writeString("invst_risk_lvl_id",invst_risk_lvl_id);
		writer.writeString("cust_grade_result_cd",cust_grade_result_cd);
		writer.writeDouble("lately_assets_num3",lately_assets_num3);
		writer.writeDouble("lately_ln_num3",lately_ln_num3);
		writer.writeDouble("lately_ccd_num3",lately_ccd_num3);
		writer.writeDouble("lately_acct_overdue_num6",lately_acct_overdue_num6);
		writer.writeDouble("day_assets_bal",day_assets_bal);
		writer.writeDouble("day_ln_bal",day_ln_bal);
		writer.writeDouble("day_cd_bal",day_cd_bal);
		writer.writeDouble("mon_ccd_amt",mon_ccd_amt);
		writer.writeDouble("lately_buy_num12",lately_buy_num12);
		writer.writeInt("retl_rgstr_sign_use_lvl_times",retl_rgstr_sign_use_lvl_times);
		writer.writeInt("ccd_rgstr_sign_use_lvl_times",ccd_rgstr_sign_use_lvl_times);
		writer.writeInt("echl_rgstr_sign_use_lvl_times",echl_rgstr_sign_use_lvl_times);
		writer.writeInt("vip_type",vip_type);
		writer.writeInt("vip_ind",vip_ind);
		writer.writeString("home_address",home_address);
		writer.writeString("home_postcode",home_postcode);
		writer.writeString("home_phone",home_phone);
		writer.writeString("corp_address",corp_address);
		writer.writeString("corp_postcode",corp_postcode);
		writer.writeString("corp_phone",corp_phone);
		writer.writeString("contact_adress",contact_adress);
		writer.writeString("contact_postcode",contact_postcode);
		writer.writeString("contact_phone",contact_phone);
		writer.writeString("mobile_phone",mobile_phone);
		writer.writeString("email",email);
		writer.writeString("cd_statement_addr",cd_statement_addr);
		writer.writeString("cd_statement_post_code",cd_statement_post_code);
		writer.writeString("cd_tel_num",cd_tel_num);
		writer.writeString("cd_mobile_num",cd_mobile_num);
		writer.writeString("cd_housing_addr",cd_housing_addr);
		writer.writeString("cd_housing_post_code",cd_housing_post_code);
		writer.writeString("cd_comp_address",cd_comp_address);
		writer.writeString("cd_comp_post_code",cd_comp_post_code);
		writer.writeString("cd_comp_tel_num",cd_comp_tel_num);
		writer.writeString("cd_email_addr",cd_email_addr);
		writer.writeString("cust_sort_name",cust_sort_name);
		writer.writeString("reg_city_cd",reg_city_cd);
		writer.writeString("live_state_cd",live_state_cd);
		writer.writeString("country_cd",country_cd);
		writer.writeString("nation_cd",nation_cd);
		writer.writeString("employee_flag",employee_flag);
		writer.writeString("unit",unit);
		writer.writeString("dept",dept);
		writer.writeString("duty",duty);
		writer.writeString("speciality",speciality);
		writer.writeString("school",school);
		writer.writeString("grad_date",grad_date);
		writer.writeDouble("year_income",year_income);
		writer.writeString("begin_bank_cust_time",begin_bank_cust_time);
		writer.writeString("mail_num",mail_num);
		writer.writeString("province_cd",province_cd);
		writer.writeString("city_cd",city_cd);
		writer.writeString("addr_bank",addr_bank);
		writer.writeString("addr_memo",addr_memo);
		writer.writeString("tel_num",tel_num);
		writer.writeString("fax_phone",fax_phone);
		writer.writeString("bill_address",bill_address);
		writer.writeString("bill_postcode",bill_postcode);
		writer.writeString("corp_name",corp_name);
		writer.writeString("en_first_name",en_first_name);
		writer.writeString("en_last_name",en_last_name);
		writer.writeString("iden_due_dt",iden_due_dt);
		writer.writeString("issue_org_country",issue_org_country);
		writer.writeString("title_cd",title_cd);
		writer.writeString("corp_property_cd",corp_property_cd);
		writer.writeString("month_income",month_income);
		writer.writeString("family_year_income",family_year_income);
		writer.writeString("other_month_income",other_month_income);
		writer.writeString("child_stat_cd",child_stat_cd);
		writer.writeString("support_num_cd",support_num_cd);
		writer.writeString("domestic_resident_ind",domestic_resident_ind);
		writer.writeString("month_income_lvl_id",month_income_lvl_id);
		writer.writeString("cust_risk_prefer_cd",cust_risk_prefer_cd);
		writer.writeString("blacklist_flag",blacklist_flag);
		writer.writeString("ceb_vip_ind",ceb_vip_ind);
		writer.writeString("agt_sal_comp_industry_class_cd",agt_sal_comp_industry_class_cd);
		writer.writeString("cust_risk_valid_end_dt",cust_risk_valid_end_dt);
		writer.writeString("currency_cd",currency_cd);
		writer.writeString("prod_cd",prod_cd);
		writer.writeString("int_start_dt",int_start_dt);
		writer.writeString("due_dt",due_dt);
		writer.writeString("close_dt",close_dt);
		writer.writeString("fin_int_org_id",fin_int_org_id);
		writer.writeString("biz_int_org_id",biz_int_org_id);
		writer.writeString("subject_num",subject_num);
		writer.writeString("biz_cd",biz_cd);
		writer.writeString("deposit_period",deposit_period);
		writer.writeString("issue_year",issue_year);
		writer.writeString("national_debt_period_num",national_debt_period_num);
		writer.writeString("national_debt_term",national_debt_term);
		writer.writeString("deposit_type_cd",deposit_type_cd);
		writer.writeString("cash_exchange_type_cd",cash_exchange_type_cd);
		writer.writeString("agmt_type_cd",agmt_type_cd);
		writer.writeString("agmt_stat_cd",agmt_stat_cd);
		writer.writeString("national_debt_type_cd",national_debt_type_cd);
		writer.writeString("latest_finance_txn_dt",latest_finance_txn_dt);
		writer.writeDouble("execute_int_rate",execute_int_rate);
		writer.writeDouble("freeze_amt",freeze_amt);
		writer.writeDouble("acct_bal_amt",acct_bal_amt);
		writer.writeDouble("year_avg_bal",year_avg_bal);
		writer.writeDouble("quarter_avg_bal",quarter_avg_bal);
		writer.writeDouble("month_avg_bal",month_avg_bal);
		writer.writeString("prod_cd1",prod_cd1);
		writer.writeString("prod_cd_type",prod_cd_type);
		writer.writeDouble("day_bal",day_bal);
		writer.writeDouble("rmb_day_bal",rmb_day_bal);
		writer.writeDouble("income_amt",income_amt);
		writer.writeDouble("crm_income_amt",crm_income_amt);
		writer.writeDouble("mon_base_bal",mon_base_bal);
		writer.writeDouble("mon_bal_avg_m3",mon_bal_avg_m3);
		writer.writeDouble("mon_bal_avg_m6",mon_bal_avg_m6);
		writer.writeDouble("mon_bal_avg_m12",mon_bal_avg_m12);
		writer.writeDouble("bal_base_qtr",bal_base_qtr);
		writer.writeDouble("bal_base_year",bal_base_year);
		writer.writeDouble("mon_base_rmb_bal1",mon_base_rmb_bal1);
		writer.writeDouble("mon_base_rmb_bal2",mon_base_rmb_bal2);
		writer.writeDouble("mon3_base_rmb_bal1",mon3_base_rmb_bal1);
		writer.writeDouble("mon3_base_rmb_bal2",mon3_base_rmb_bal2);
		writer.writeDouble("mon6_base_rmb_bal1",mon6_base_rmb_bal1);
		writer.writeDouble("mon6_base_rmb_bal2",mon6_base_rmb_bal2);
		writer.writeDouble("mon12_base_rmb_bal1",mon12_base_rmb_bal1);
		writer.writeDouble("mon12_base_rmb_bal2",mon12_base_rmb_bal2);
		writer.writeDouble("qtr_base_rmb_bal1",qtr_base_rmb_bal1);
		writer.writeDouble("qtr_base_rmb_bal2",qtr_base_rmb_bal2);
		writer.writeDouble("year_base_rmb_bal1",year_base_rmb_bal1);
		writer.writeDouble("year_base_rmb_bal2",year_base_rmb_bal2);
		writer.writeDouble("mon_base_for_bal1",mon_base_for_bal1);
		writer.writeDouble("mon_base_for_bal2",mon_base_for_bal2);
		writer.writeDouble("mon3_base_for_bal1",mon3_base_for_bal1);
		writer.writeDouble("mon3_base_for_bal2",mon3_base_for_bal2);
		writer.writeDouble("mon6_base_for_bal1",mon6_base_for_bal1);
		writer.writeDouble("mon6_base_for_bal2",mon6_base_for_bal2);
		writer.writeDouble("mon12_base_for_bal1",mon12_base_for_bal1);
		writer.writeDouble("mon12_base_for_bal2",mon12_base_for_bal2);
		writer.writeDouble("qtr_base_for_bal1",qtr_base_for_bal1);
		writer.writeDouble("qtr_base_for_bal2",qtr_base_for_bal2);
		writer.writeDouble("year_base_for_bal1",year_base_for_bal1);
		writer.writeDouble("year_base_for_bal2",year_base_for_bal2);
		writer.writeDouble("mon_base_profit",mon_base_profit);
		writer.writeDouble("rmb_day_profit",rmb_day_profit);
		writer.writeDouble("crm_day_profit",crm_day_profit);
		writer.writeString("crm_prod_cd",crm_prod_cd);
	}
	...
	public void fromData(PdxReader reader) {
		...
		open_subbank_id=reader.readString("open_subbank_id");
		open_mon=reader.readInt("open_mon");
		cust_act_ind=reader.readString("cust_act_ind");
		profit=reader.readDouble("profit");
		dept_profit=reader.readDouble("dept_profit");
		loan_profit=reader.readDouble("loan_profit");
		ibiz_profit=reader.readDouble("ibiz_profit");
		cd_profit=reader.readDouble("cd_profit");
		profit_rate=reader.readDouble("profit_rate");
		dept_acct_qty=reader.readInt("dept_acct_qty");
		dept_bal_amt=reader.readDouble("dept_bal_amt");
		dept_month_avg_bal=reader.readDouble("dept_month_avg_bal");
		dept_quarter_avg_bal=reader.readDouble("dept_quarter_avg_bal");
		dept_year_avg_bal=reader.readDouble("dept_year_avg_bal");
		fixed_dept_acct_qty=reader.readInt("fixed_dept_acct_qty");
		fixed_dept_bal_amt=reader.readDouble("fixed_dept_bal_amt");
		fixed_dept_month_avg_bal=reader.readDouble("fixed_dept_month_avg_bal");
		fixed_dept_quarter_avg_bal=reader.readDouble("fixed_dept_quarter_avg_bal");
		fixed_dept_year_avg_bal=reader.readDouble("fixed_dept_year_avg_bal");
		saving_dept_acct_qty=reader.readInt("saving_dept_acct_qty");
		saving_dept_bal_amt=reader.readDouble("saving_dept_bal_amt");
		saving_dept_month_avg_bal=reader.readDouble("saving_dept_month_avg_bal");
		saving_dept_quarter_avg_bal=reader.readDouble("saving_dept_quarter_avg_bal");
		saving_dept_year_avg_bal=reader.readDouble("saving_dept_year_avg_bal");
		l_dept_acct_qty=reader.readInt("l_dept_acct_qty");
		l_dept_bal_amt=reader.readDouble("l_dept_bal_amt");
		l_dept_month_avg_bal=reader.readDouble("l_dept_month_avg_bal");
		l_dept_quarter_avg_bal=reader.readDouble("l_dept_quarter_avg_bal");
		l_dept_year_avg_bal=reader.readDouble("l_dept_year_avg_bal");
		f_dept_acct_qty=reader.readInt("f_dept_acct_qty");
		f_dept_bal_amt=reader.readDouble("f_dept_bal_amt");
		f_dept_month_avg_bal=reader.readDouble("f_dept_month_avg_bal");
		f_dept_quarter_avg_bal=reader.readDouble("f_dept_quarter_avg_bal");
		f_dept_year_avg_bal=reader.readDouble("f_dept_year_avg_bal");
		fin_type_qty=reader.readInt("fin_type_qty");
		fin_acct_qty=reader.readInt("fin_acct_qty");
		fin_bal_amt=reader.readDouble("fin_bal_amt");
		fin_month_avg_bal=reader.readDouble("fin_month_avg_bal");
		fin_quarter_avg_bal=reader.readDouble("fin_quarter_avg_bal");
		fin_year_avg_bal=reader.readDouble("fin_year_avg_bal");
		l_fin_type_qty=reader.readInt("l_fin_type_qty");
		l_fin_acct_qty=reader.readInt("l_fin_acct_qty");
		l_fin_bal_amt=reader.readDouble("l_fin_bal_amt");
		l_fin_month_avg_bal=reader.readDouble("l_fin_month_avg_bal");
		l_fin_quarter_avg_bal=reader.readDouble("l_fin_quarter_avg_bal");
		l_fin_year_avg_bal=reader.readDouble("l_fin_year_avg_bal");
		f_fin_type_qty=reader.readInt("f_fin_type_qty");
		f_fin_acct_qty=reader.readInt("f_fin_acct_qty");
		f_fin_bal_amt=reader.readDouble("f_fin_bal_amt");
		f_fin_month_avg_bal=reader.readDouble("f_fin_month_avg_bal");
		f_fin_quarter_avg_bal=reader.readDouble("f_fin_quarter_avg_bal");
		f_fin_year_avg_bal=reader.readDouble("f_fin_year_avg_bal");
		fin_dept_acct_qty=reader.readInt("fin_dept_acct_qty");
		fin_dept_bal_amt=reader.readDouble("fin_dept_bal_amt");
		fin_dept_month_avg_bal=reader.readDouble("fin_dept_month_avg_bal");
		fin_dept_quarter_avg_bal=reader.readDouble("fin_dept_quarter_avg_bal");
		fin_dept_year_avg_bal=reader.readDouble("fin_dept_year_avg_bal");
		l_fin_dept_acct_qty=reader.readInt("l_fin_dept_acct_qty");
		l_fin_dept_bal_amt=reader.readDouble("l_fin_dept_bal_amt");
		l_fin_dept_month_avg_bal=reader.readDouble("l_fin_dept_month_avg_bal");
		l_fin_dept_quarter_avg_bal=reader.readDouble("l_fin_dept_quarter_avg_bal");
		l_fin_dept_year_avg_bal=reader.readDouble("l_fin_dept_year_avg_bal");
		f_fin_dept_acct_qty=reader.readInt("f_fin_dept_acct_qty");
		f_fin_dept_bal_amt=reader.readDouble("f_fin_dept_bal_amt");
		f_fin_dept_month_avg_bal=reader.readDouble("f_fin_dept_month_avg_bal");
		f_fin_dept_quarter_avg_bal=reader.readDouble("f_fin_dept_quarter_avg_bal");
		f_fin_dept_year_avg_bal=reader.readDouble("f_fin_dept_year_avg_bal");
		l_fin_fund_acct_qty=reader.readInt("l_fin_fund_acct_qty");
		l_fin_fund_bal_amt=reader.readDouble("l_fin_fund_bal_amt");
		l_fin_fund_month_avg_bal=reader.readDouble("l_fin_fund_month_avg_bal");
		l_fin_fund_quarter_avg_bal=reader.readDouble("l_fin_fund_quarter_avg_bal");
		l_fin_fund_year_avg_bal=reader.readDouble("l_fin_fund_year_avg_bal");
		f_fin_fund_acct_qty=reader.readInt("f_fin_fund_acct_qty");
		f_fin_fund_bal_amt=reader.readDouble("f_fin_fund_bal_amt");
		f_fin_fund_month_avg_bal=reader.readDouble("f_fin_fund_month_avg_bal");
		f_fin_fund_quarter_avg_bal=reader.readDouble("f_fin_fund_quarter_avg_bal");
		f_fin_fund_year_avg_bal=reader.readDouble("f_fin_fund_year_avg_bal");
		debt_acct_qty=reader.readInt("debt_acct_qty");
		debt_bal_amt=reader.readDouble("debt_bal_amt");
		debt_month_avg_bal=reader.readDouble("debt_month_avg_bal");
		debt_quarter_avg_bal=reader.readDouble("debt_quarter_avg_bal");
		debt_year_avg_bal=reader.readDouble("debt_year_avg_bal");
		fund_acct_qty=reader.readInt("fund_acct_qty");
		fund_bal_amt=reader.readDouble("fund_bal_amt");
		fund_month_avg_bal=reader.readDouble("fund_month_avg_bal");
		fund_quarter_avg_bal=reader.readDouble("fund_quarter_avg_bal");
		fund_year_avg_bal=reader.readDouble("fund_year_avg_bal");
		gold_acct_qty=reader.readInt("gold_acct_qty");
		gold_bal=reader.readDouble("gold_bal");
		mon_avg_gold_bal=reader.readDouble("mon_avg_gold_bal");
		qtr_avg_gold_bal=reader.readDouble("qtr_avg_gold_bal");
		year_avg_gold_bal=reader.readDouble("year_avg_gold_bal");
		ins_acct_qty=reader.readInt("ins_acct_qty");
		ins_bal=reader.readDouble("ins_bal");
		mon_avg_ins_bal=reader.readDouble("mon_avg_ins_bal");
		qtr_avg_ins_bal=reader.readDouble("qtr_avg_ins_bal");
		year_avg_ins_bal=reader.readDouble("year_avg_ins_bal");
		sjob_acct_qty=reader.readInt("sjob_acct_qty");
		sjob_bal=reader.readDouble("sjob_bal");
		mon_avg_sjob_bal=reader.readDouble("mon_avg_sjob_bal");
		qtr_avg_sjob_bal=reader.readDouble("qtr_avg_sjob_bal");
		year_avg_sjob_bal=reader.readDouble("year_avg_sjob_bal");
		accd_acct_qty=reader.readInt("accd_acct_qty");
		accd_bal=reader.readDouble("accd_bal");
		mon_avg_accd_bal=reader.readDouble("mon_avg_accd_bal");
		qtr_avg_accd_bal=reader.readDouble("qtr_avg_accd_bal");
		year_avg_accd_bal=reader.readDouble("year_avg_accd_bal");
		ta_fin_acct_qty=reader.readInt("ta_fin_acct_qty");
		ta_fin_bal_amt=reader.readDouble("ta_fin_bal_amt");
		ta_fin_month_avg_bal=reader.readDouble("ta_fin_month_avg_bal");
		ta_fin_quarter_avg_bal=reader.readDouble("ta_fin_quarter_avg_bal");
		ta_fin_year_avg_bal=reader.readDouble("ta_fin_year_avg_bal");
		dept_trs_acct_qty=reader.readInt("dept_trs_acct_qty");
		dept_trs_bal_amt=reader.readDouble("dept_trs_bal_amt");
		dept_trs_month_avg_bal=reader.readDouble("dept_trs_month_avg_bal");
		dept_trs_quarter_avg_bal=reader.readDouble("dept_trs_quarter_avg_bal");
		dept_trs_year_avg_bal=reader.readDouble("dept_trs_year_avg_bal");
		l_dept_trs_acct_qty=reader.readInt("l_dept_trs_acct_qty");
		l_dept_trs_bal_amt=reader.readDouble("l_dept_trs_bal_amt");
		l_dept_trs_month_avg_bal=reader.readDouble("l_dept_trs_month_avg_bal");
		l_dept_trs_quarter_avg_bal=reader.readDouble("l_dept_trs_quarter_avg_bal");
		l_dept_trs_year_avg_bal=reader.readDouble("l_dept_trs_year_avg_bal");
		loan_acct_qty=reader.readInt("loan_acct_qty");
		loan_issue_amt=reader.readDouble("loan_issue_amt");
		loan_bal_amt=reader.readDouble("loan_bal_amt");
		nloan_amt=reader.readDouble("nloan_amt");
		loan_month_avg_bal=reader.readDouble("loan_month_avg_bal");
		loan_quarter_avg_bal=reader.readDouble("loan_quarter_avg_bal");
		loan_year_avg_bal=reader.readDouble("loan_year_avg_bal");
		micro_acct_qty=reader.readInt("micro_acct_qty");
		micro_issue_amt=reader.readDouble("micro_issue_amt");
		micro_bal_amt=reader.readDouble("micro_bal_amt");
		micro_month_avg_bal=reader.readDouble("micro_month_avg_bal");
		micro_quarter_avg_bal=reader.readDouble("micro_quarter_avg_bal");
		micro_year_avg_bal=reader.readDouble("micro_year_avg_bal");
		sc_acct_qty=reader.readInt("sc_acct_qty");
		sc_bal_amt=reader.readDouble("sc_bal_amt");
		sc_bal_month_avg_bal=reader.readDouble("sc_bal_month_avg_bal");
		sc_bal_quarter_avg_bal=reader.readDouble("sc_bal_quarter_avg_bal");
		sc_bal_year_avg_bal=reader.readDouble("sc_bal_year_avg_bal");
		ccard_acct_qty=reader.readInt("ccard_acct_qty");
		ccard_card_qty=reader.readInt("ccard_card_qty");
		ccard_limit_amt=reader.readDouble("ccard_limit_amt");
		ccard_usable_amt=reader.readDouble("ccard_usable_amt");
		ccard_month_amt=reader.readDouble("ccard_month_amt");
		ccard_year_amt=reader.readDouble("ccard_year_amt");
		ccard_year_avg_amt=reader.readDouble("ccard_year_avg_amt");
		ccard_total_purchases_amt=reader.readDouble("ccard_total_purchases_amt");
		ast2_bal_amt=reader.readDouble("ast2_bal_amt");
		ast2_month_avg_bal=reader.readDouble("ast2_month_avg_bal");
		ast2_quarter_avg_bal=reader.readDouble("ast2_quarter_avg_bal");
		ast2_year_avg_bal=reader.readDouble("ast2_year_avg_bal");
		ast4_bal_amt=reader.readDouble("ast4_bal_amt");
		ast4_month_avg_bal=reader.readDouble("ast4_month_avg_bal");
		ast4_quarter_avg_bal=reader.readDouble("ast4_quarter_avg_bal");
		ast4_year_avg_bal=reader.readDouble("ast4_year_avg_bal");
		assert9_bal=reader.readDouble("assert9_bal");
		mon_avg_assert9_bal=reader.readDouble("mon_avg_assert9_bal");
		qtr_avg_assert9_bal=reader.readDouble("qtr_avg_assert9_bal");
		year_avg_assert9_bal=reader.readDouble("year_avg_assert9_bal");
		hold_dept_ind=reader.readInt("hold_dept_ind");
		hold_fin_ind=reader.readInt("hold_fin_ind");
		hold_debt_ind=reader.readInt("hold_debt_ind");
		hold_fund_ind=reader.readInt("hold_fund_ind");
		hold_loan_ind=reader.readInt("hold_loan_ind");
		hold_sc_ind=reader.readInt("hold_sc_ind");
		hold_ccard_ind=reader.readInt("hold_ccard_ind");
		hold_gold_ind=reader.readInt("hold_gold_ind");
		hold_ins_ind=reader.readInt("hold_ins_ind");
		hold_sjob_ind=reader.readInt("hold_sjob_ind");
		hold_accd_ind=reader.readInt("hold_accd_ind");
		hold_prod_type_num=reader.readInt("hold_prod_type_num");
		hold_prod_num=reader.readInt("hold_prod_num");
		sc_sign_ind=reader.readInt("sc_sign_ind");
		sc_sign_dt=reader.readString("sc_sign_dt");
		nb_sign_ind=reader.readInt("nb_sign_ind");
		nb_sign_dt=reader.readString("nb_sign_dt");
		mb_sign_ind=reader.readInt("mb_sign_ind");
		mb_sign_dt=reader.readString("mb_sign_dt");
		sms_sign_ind=reader.readInt("sms_sign_ind");
		sms_sign_dt=reader.readString("sms_sign_dt");
		saly_sign_ind=reader.readInt("saly_sign_ind");
		...
		prod_num=reader.readInt("prod_num");
		prod_sav=reader.readString("prod_sav");
		prod_fin=reader.readString("prod_fin");
		prod_fin_nav=reader.readString("prod_fin_nav");
		prod_fin_fixed_income=reader.readString("prod_fin_fixed_income");
		prod_fin_indiv=reader.readString("prod_fin_indiv");
		prod_fun=reader.readString("prod_fun");
		prod_bon=reader.readString("prod_bon");
		prod_sec=reader.readString("prod_sec");
		prod_gld=reader.readString("prod_gld");
		prod_tru=reader.readString("prod_tru");
		prod_pot=reader.readString("prod_pot");
		prod_idr=reader.readString("prod_idr");
		prod_lod=reader.readString("prod_lod");
		prod_lod_house=reader.readString("prod_lod_house");
		prod_lod_compre_cre=reader.readString("prod_lod_compre_cre");
		prod_lod_compre_oth=reader.readString("prod_lod_compre_oth");
		prod_lod_ple=reader.readString("prod_lod_ple");
		prod_lod_entru=reader.readString("prod_lod_entru");
		prod_crd=reader.readString("prod_crd");
		prod_mic=reader.readString("prod_mic");
		prod_mic_coml_mortg=reader.readString("prod_mic_coml_mortg");
		prod_mic_housing=reader.readString("prod_mic_housing");
		prod_mic_oth_aid=reader.readString("prod_mic_oth_aid");
		prod_mic_chan=reader.readString("prod_mic_chan");
		prod_mic_cons=reader.readString("prod_mic_cons");
		prod_pay=reader.readString("prod_pay");
		prod_btch_cr=reader.readString("prod_btch_cr");
		prod_btch_dr=reader.readString("prod_btch_dr");
		prod_fxa=reader.readString("prod_fxa");
		prod_fxa_settle=reader.readString("prod_fxa_settle");
		prod_fxa_dept=reader.readString("prod_fxa_dept");
		prod_fbp=reader.readString("prod_fbp");
		prod_elc=reader.readString("prod_elc");
		prod_ela=reader.readString("prod_ela");
		prod_clt=reader.readString("prod_clt");
		prod_p2p=reader.readString("prod_p2p");
		prod_mcm=reader.readString("prod_mcm");
		hold_res1=reader.readString("hold_res1");
		hold_res2=reader.readString("hold_res2");
		hold_res3=reader.readString("hold_res3");
		group_deposit=reader.readString("group_deposit");
		group_fincing=reader.readString("group_fincing");
		group_na_fincing=reader.readString("group_na_fincing");
		group_fincing_agent=reader.readString("group_fincing_agent");
		group_fincing_agent_fud=reader.readString("group_fincing_agent_fud");
		group_fincing_agent_ins=reader.readString("group_fincing_agent_ins");
		group_fincing_agent_tru=reader.readString("group_fincing_agent_tru");
		group_fincing_agent_bon=reader.readString("group_fincing_agent_bon");
		group_fincing_sc=reader.readString("group_fincing_sc");
		group_microbiz=reader.readString("group_microbiz");
		group_mic_loan=reader.readString("group_mic_loan");
		group_mic_loan_com=reader.readString("group_mic_loan_com");
		group_mic_loan_hous=reader.readString("group_mic_loan_hous");
		group_mic_loan_oth=reader.readString("group_mic_loan_oth");
		group_mic_loan_chan=reader.readString("group_mic_loan_chan");
		group_mic_loan_cons=reader.readString("group_mic_loan_cons");
		group_mic_rela=reader.readString("group_mic_rela");
		group_loan=reader.readString("group_loan");
		group_loan_house=reader.readString("group_loan_house");
		group_loan_compre=reader.readString("group_loan_compre");
		group_loan_compre_cre=reader.readString("group_loan_compre_cre");
		group_loan_compre_oth=reader.readString("group_loan_compre_oth");
		group_loan_ple=reader.readString("group_loan_ple");
		group_loan_ent=reader.readString("group_loan_ent");
		group_creditcard=reader.readString("group_creditcard");
		group_batch_cr=reader.readString("group_batch_cr");
		group_batch_salary=reader.readString("group_batch_salary");
		group_batch_inter=reader.readString("group_batch_inter");
		group_batch_spec=reader.readString("group_batch_spec");
		group_batch_oth=reader.readString("group_batch_oth");
		group_finaboard=reader.readString("group_finaboard");
		group_finaboard_settle=reader.readString("group_finaboard_settle");
		group_finaboard_dept=reader.readString("group_finaboard_dept");
		group_finaboard_sun=reader.readString("group_finaboard_sun");
		group_pwm=reader.readString("group_pwm");
		group_res1=reader.readString("group_res1");
		group_res2=reader.readString("group_res2");
		group_res3=reader.readString("group_res3");
		cust_flag=reader.readInt("cust_flag");
		asset_debit_lvl_id=reader.readString("asset_debit_lvl_id");
		asset_debit_lvl_cid=reader.readString("asset_debit_lvl_cid");
		fin_asset_debit_lvl_id=reader.readString("fin_asset_debit_lvl_id");
		fin_asset_debit_lvl_cid=reader.readString("fin_asset_debit_lvl_cid");
		fin_mon1=reader.readString("fin_mon1");
		fin_mon2=reader.readString("fin_mon2");
		fin_mon3=reader.readString("fin_mon3");
		ccd_asset_debit_lvl_id=reader.readString("ccd_asset_debit_lvl_id");
		ln_asset_debit_lvl_id=reader.readString("ln_asset_debit_lvl_id");
		ln_asset_debit_lvl_cid=reader.readString("ln_asset_debit_lvl_cid");
		ln_mon1=reader.readString("ln_mon1");
		ln_mon2=reader.readString("ln_mon2");
		ln_mon3=reader.readString("ln_mon3");
		ln_mon4=reader.readString("ln_mon4");
		ln_mon5=reader.readString("ln_mon5");
		ln_mon6=reader.readString("ln_mon6");
		asset_debit_lvl_times=reader.readInt("asset_debit_lvl_times");
		fin_asset_debit_lvl_times=reader.readInt("fin_asset_debit_lvl_times");
		ln_asset_debit_lvl_times=reader.readInt("ln_asset_debit_lvl_times");
		ccd_asset_debit_lvl_times=reader.readInt("ccd_asset_debit_lvl_times");
		cust_flg=reader.readString("cust_flg");
		cust_lost_flg=reader.readInt("cust_lost_flg");
		assets_debt_lvl_cd=reader.readString("assets_debt_lvl_cd");
		fin_assets_debt_lvl_cd=reader.readString("fin_assets_debt_lvl_cd");
		ln_assets_debt_lvl_cd=reader.readString("ln_assets_debt_lvl_cd");
		ccd_assets_debt_lvl_cd=reader.readString("ccd_assets_debt_lvl_cd");
		assets_lvl_cd=reader.readString("assets_lvl_cd");
		profit_lvl_cd=reader.readString("profit_lvl_cd");
		day_profit=reader.readDouble("day_profit");
		profit_mon_base=reader.readDouble("profit_mon_base");
		rgstr_sign_use_lvl_id=reader.readString("rgstr_sign_use_lvl_id");
		retl_rgstr_sign_use_lvl_id=reader.readString("retl_rgstr_sign_use_lvl_id");
		ccd_rgstr_sign_use_lvl_id=reader.readString("ccd_rgstr_sign_use_lvl_id");
		echl_rgstr_sign_use_lvl_id=reader.readString("echl_rgstr_sign_use_lvl_id");
		buy_freq_lvl_id=reader.readString("buy_freq_lvl_id");
		activ_lvl_id=reader.readString("activ_lvl_id");
		retl_activ_lvl_id=reader.readString("retl_activ_lvl_id");
		ccd_activ_lvl_id=reader.readString("ccd_activ_lvl_id");
		echl_activ_lvl_id=reader.readString("echl_activ_lvl_id");
		cust_lylty=reader.readString("cust_lylty");
		lylty_lvl_id=reader.readString("lylty_lvl_id");
		fin_manager=reader.readString("fin_manager");
		ln_manager=reader.readString("ln_manager");
		ccd_manager=reader.readString("ccd_manager");
		invst_risk_lvl_id=reader.readString("invst_risk_lvl_id");
		cust_grade_result_cd=reader.readString("cust_grade_result_cd");
		lately_assets_num3=reader.readDouble("lately_assets_num3");
		lately_ln_num3=reader.readDouble("lately_ln_num3");
		lately_ccd_num3=reader.readDouble("lately_ccd_num3");
		lately_acct_overdue_num6=reader.readDouble("lately_acct_overdue_num6");
		day_assets_bal=reader.readDouble("day_assets_bal");
		day_ln_bal=reader.readDouble("day_ln_bal");
		day_cd_bal=reader.readDouble("day_cd_bal");
		mon_ccd_amt=reader.readDouble("mon_ccd_amt");
		lately_buy_num12=reader.readDouble("lately_buy_num12");
		retl_rgstr_sign_use_lvl_times=reader.readInt("retl_rgstr_sign_use_lvl_times");
		ccd_rgstr_sign_use_lvl_times=reader.readInt("ccd_rgstr_sign_use_lvl_times");
		echl_rgstr_sign_use_lvl_times=reader.readInt("echl_rgstr_sign_use_lvl_times");
		vip_type=reader.readInt("vip_type");
		vip_ind=reader.readInt("vip_ind");
		home_address=reader.readString("home_address");
		home_postcode=reader.readString("home_postcode");
		home_phone=reader.readString("home_phone");
		corp_address=reader.readString("corp_address");
		corp_postcode=reader.readString("corp_postcode");
		corp_phone=reader.readString("corp_phone");
		contact_adress=reader.readString("contact_adress");
		contact_postcode=reader.readString("contact_postcode");
		contact_phone=reader.readString("contact_phone");
		mobile_phone=reader.readString("mobile_phone");
		email=reader.readString("email");
		cd_statement_addr=reader.readString("cd_statement_addr");
		cd_statement_post_code=reader.readString("cd_statement_post_code");
		cd_tel_num=reader.readString("cd_tel_num");
		cd_mobile_num=reader.readString("cd_mobile_num");
		cd_housing_addr=reader.readString("cd_housing_addr");
		cd_housing_post_code=reader.readString("cd_housing_post_code");
		cd_comp_address=reader.readString("cd_comp_address");
		cd_comp_post_code=reader.readString("cd_comp_post_code");
		cd_comp_tel_num=reader.readString("cd_comp_tel_num");
		cd_email_addr=reader.readString("cd_email_addr");
		cust_sort_name=reader.readString("cust_sort_name");
		reg_city_cd=reader.readString("reg_city_cd");
		live_state_cd=reader.readString("live_state_cd");
		country_cd=reader.readString("country_cd");
		nation_cd=reader.readString("nation_cd");
		employee_flag=reader.readString("employee_flag");
		unit=reader.readString("unit");
		dept=reader.readString("dept");
		duty=reader.readString("duty");
		speciality=reader.readString("speciality");
		school=reader.readString("school");
		grad_date=reader.readString("grad_date");
		year_income=reader.readInt("year_income");
		begin_bank_cust_time=reader.readString("begin_bank_cust_time");
		mail_num=reader.readString("mail_num");
		province_cd=reader.readString("province_cd");
		city_cd=reader.readString("city_cd");
		addr_bank=reader.readString("addr_bank");
		addr_memo=reader.readString("addr_memo");
		tel_num=reader.readString("tel_num");
		fax_phone=reader.readString("fax_phone");
		bill_address=reader.readString("bill_address");
		bill_postcode=reader.readString("bill_postcode");
		corp_name=reader.readString("corp_name");
		en_first_name=reader.readString("en_first_name");
		en_last_name=reader.readString("en_last_name");
		iden_due_dt=reader.readString("iden_due_dt");
		issue_org_country=reader.readString("issue_org_country");
		title_cd=reader.readString("title_cd");
		corp_property_cd=reader.readString("corp_property_cd");
		month_income=reader.readString("month_income");
		family_year_income=reader.readString("family_year_income");
		other_month_income=reader.readString("other_month_income");
		child_stat_cd=reader.readString("child_stat_cd");
		support_num_cd=reader.readString("support_num_cd");
		domestic_resident_ind=reader.readString("domestic_resident_ind");
		month_income_lvl_id=reader.readString("month_income_lvl_id");
		cust_risk_prefer_cd=reader.readString("cust_risk_prefer_cd");
		blacklist_flag=reader.readString("blacklist_flag");
		ceb_vip_ind=reader.readString("ceb_vip_ind");
		agt_sal_comp_industry_class_cd=reader.readString("agt_sal_comp_industry_class_cd");
		cust_risk_valid_end_dt=reader.readString("cust_risk_valid_end_dt");
		currency_cd=reader.readString("currency_cd");
		prod_cd=reader.readString("prod_cd");
		int_start_dt=reader.readString("int_start_dt");
		due_dt=reader.readString("due_dt");
		close_dt=reader.readString("close_dt");
		fin_int_org_id=reader.readString("fin_int_org_id");
		biz_int_org_id=reader.readString("biz_int_org_id");
		subject_num=reader.readString("subject_num");
		biz_cd=reader.readString("biz_cd");
		deposit_period=reader.readString("deposit_period");
		issue_year=reader.readString("issue_year");
		national_debt_period_num=reader.readString("national_debt_period_num");
		national_debt_term=reader.readString("national_debt_term");
		deposit_type_cd=reader.readString("deposit_type_cd");
		cash_exchange_type_cd=reader.readString("cash_exchange_type_cd");
		agmt_type_cd=reader.readString("agmt_type_cd");
		agmt_stat_cd=reader.readString("agmt_stat_cd");
		national_debt_type_cd=reader.readString("national_debt_type_cd");
		latest_finance_txn_dt=reader.readString("latest_finance_txn_dt");
		execute_int_rate=reader.readDouble("execute_int_rate");
		freeze_amt=reader.readDouble("freeze_amt");
		acct_bal_amt=reader.readDouble("acct_bal_amt");
		year_avg_bal=reader.readDouble("year_avg_bal");
		quarter_avg_bal=reader.readDouble("quarter_avg_bal");
		month_avg_bal=reader.readDouble("month_avg_bal");
		prod_cd1=reader.readString("prod_cd1");
		prod_cd_type=reader.readString("prod_cd_type");
		day_bal=reader.readDouble("day_bal");
		rmb_day_bal=reader.readDouble("rmb_day_bal");
		income_amt=reader.readDouble("income_amt");
		crm_income_amt=reader.readDouble("crm_income_amt");
		mon_base_bal=reader.readDouble("mon_base_bal");
		mon_bal_avg_m3=reader.readDouble("mon_bal_avg_m3");
		mon_bal_avg_m6=reader.readDouble("mon_bal_avg_m6");
		mon_bal_avg_m12=reader.readDouble("mon_bal_avg_m12");
		bal_base_qtr=reader.readDouble("bal_base_qtr");
		bal_base_year=reader.readDouble("bal_base_year");
		mon_base_rmb_bal1=reader.readDouble("mon_base_rmb_bal1");
		mon_base_rmb_bal2=reader.readDouble("mon_base_rmb_bal2");
		mon3_base_rmb_bal1=reader.readDouble("mon3_base_rmb_bal1");
		mon3_base_rmb_bal2=reader.readDouble("mon3_base_rmb_bal2");
		mon6_base_rmb_bal1=reader.readDouble("mon6_base_rmb_bal1");
		mon6_base_rmb_bal2=reader.readDouble("mon6_base_rmb_bal2");
		mon12_base_rmb_bal1=reader.readDouble("mon12_base_rmb_bal1");
		mon12_base_rmb_bal2=reader.readDouble("mon12_base_rmb_bal2");
		qtr_base_rmb_bal1=reader.readDouble("qtr_base_rmb_bal1");
		qtr_base_rmb_bal2=reader.readDouble("qtr_base_rmb_bal2");
		year_base_rmb_bal1=reader.readDouble("year_base_rmb_bal1");
		year_base_rmb_bal2=reader.readDouble("year_base_rmb_bal2");
		mon_base_for_bal1=reader.readDouble("mon_base_for_bal1");
		mon_base_for_bal2=reader.readDouble("mon_base_for_bal2");
		mon3_base_for_bal1=reader.readDouble("mon3_base_for_bal1");
		mon3_base_for_bal2=reader.readDouble("mon3_base_for_bal2");
		mon6_base_for_bal1=reader.readDouble("mon6_base_for_bal1");
		mon6_base_for_bal2=reader.readDouble("mon6_base_for_bal2");
		mon12_base_for_bal1=reader.readDouble("mon12_base_for_bal1");
		mon12_base_for_bal2=reader.readDouble("mon12_base_for_bal2");
		qtr_base_for_bal1=reader.readDouble("qtr_base_for_bal1");
		qtr_base_for_bal2=reader.readDouble("qtr_base_for_bal2");
		year_base_for_bal1=reader.readDouble("year_base_for_bal1");
		year_base_for_bal2=reader.readDouble("year_base_for_bal2");
		mon_base_profit=reader.readDouble("mon_base_profit");
		rmb_day_profit=reader.readDouble("rmb_day_profit");
		crm_day_profit=reader.readDouble("crm_day_profit");
		crm_prod_cd=reader.readString("crm_prod_cd");
	}
